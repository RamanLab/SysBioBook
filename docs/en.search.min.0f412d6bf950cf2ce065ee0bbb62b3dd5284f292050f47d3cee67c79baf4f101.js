...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6b46cdd87244d1baab6245263925a41822e64ae5fb664aae8f57a91bedd85e9a.js',function(){input.required=false;search();});}
