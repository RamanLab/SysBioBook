...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/SysBioBook/flexsearch.min.js');loadScript('/SysBioBook/en.search-data.min.bbe0b7d933173f8a369829b7c89263ae835d3daa7be1f2de20d6b85a566a9b82.js',function(){input.required=false;search();});}
